...
export const api = {
  ...
  mediaPreviewUrl: (name: string, index: number, o: { with_rois?: boolean; frame_stats?: boolean; timestamp?: boolean; colorbar?: boolean; title?: string | null; plot_series?: string[]; overlay_rois?: number[]; visible_opacity?: number; start?: number; stop?: number }) =>
