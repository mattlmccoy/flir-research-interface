...
- [ ] Parity batch 3: reference-frame subtraction, pan when zoomed, focus control (if FOL08 supports it), Research Studio validation table (needs a session with Research Studio), M10 clean-Mac end-to-end + Linux systemd + Windows.
